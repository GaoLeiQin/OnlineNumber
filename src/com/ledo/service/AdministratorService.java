...
import static com.ledo.common.FileManager.SERVER_OPENDAYS_PATH;
...
public class AdministratorService implements IAdministratorService{
    ...
    public void addServerInfo() {
        ...
        if (urlContentDao.queryOfficialSum() == null || urlContentDao.queryMixSum() == null ||
                urlContentDao.queryGatSum() == null || urlContentDao.queryAllSum() == null) {
            logger.error(" ______________________________网页访问为空的数据：" + server + "__________________________");
        }
    ...
    private void getFiles(String fileName) {
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                getRachargeInfo(str, getZoneIdByFilename(fileName));
            }
