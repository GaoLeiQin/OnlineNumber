...
<div id="all" style="margin-left: 15%; margin-top: 5%">
    <input class="autoUrlContent" type="button" value="自动更新网页内容"
           onclick="javasript:window.open('autoUpdateUrlContent.do')"/> &nbsp; &nbsp;
    <input class="autoHistory" type="button" value="自动更新历史数据"
           onclick="javasript:window.open('autoInsertOnlineServerInfo.do')"/> &nbsp; &nbsp;
    <br><br><br><<br>
    <input class="queryRechargeInfo" type="button" value="点击查询充值信息"
           onclick="javasript:window.open('/OnlineNumber/recharge/rechargeInfo.do')"/> &nbsp; &nbsp;
