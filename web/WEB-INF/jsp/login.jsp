...
<head>
    <title>登录</title>
    <link rel="icon" href="/OnlineNumber/images/login.png" type="image/x-icon"/>
    <link rel="icon" href="../images/favicon.ico" type="image/x-icon">
    <script type="text/javascript" src="/OnlineNumber/chartJS/jquery.min.js"></script>
</head>
...
<body style="background: url(/OnlineNumber/images/login.png) no-repeat; background-size: contain">
...
<div id="user_login" class="easyui-dialog" title="用户登录" closed="false" buttons="#dlg-buttons" style="height: 180px;width:340px;margin-top: 18%;margin-left: 40%">
    <form id="login" method="POST" style="top: 100px; left: 200px;">
        ...
        <div id="submit" style="margin-left: 100px">
            <input class="guest" type="button" onclick="verify()" value="访客登录"/> &nbsp;
...
<script type="text/javascript">
    ...
    function adminVerify() {
        ...
        $.ajax({
            type: 'post',
            url: '/OnlineNumber/adminVerify.do',
