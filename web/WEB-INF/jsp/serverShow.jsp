...
<font color="#00008b" style="margin-left: 45%"> （建议刷新间隔时间：2分钟） </font>

<div style="opacity: 0.8 ">
    <input class="history" type="button" value="在线历史信息"  onclick="javasript:window.open('historyByCondition.do')"/> &nbsp; &nbsp;
    <input class="linux" type="button" value="服务器详细信息" onclick="javasript:window.open('/OnlineNumber/allServer/queryServerInfoByCondition.do')" /> &nbsp; &nbsp;
</div>
